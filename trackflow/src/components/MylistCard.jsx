...
const MylistCard = ({ task, trueState, onToggle }) => {
  const { id, title, description, isdone, duedate, status, image } = task;

  return (
    <div className="flex  border-2 hover:shadow-md transition-all mb-4  border-gray-100 rounded-lg p-3 hover:border-blue-300 items-center gap-3">
      <div>
