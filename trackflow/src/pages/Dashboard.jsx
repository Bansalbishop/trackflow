      ...
      >
        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row justify-evenly">
            ...
            <div className="  md:w-2/3 flex items-start bg-transparent my-10 mx-5 sm:mr-5 md:mr-20 lg:mr-40 rounded-2xl  text-black gap-5  flex-col lg:flex-row justify-evenly">
